class NavigationMenu extends HTMLElement {
    ...
    static displayAllTextCache = null;
        ...
        salla.onReady()
            ...
            .then(() => {
                ...
                if (NavigationMenu.menusCache && NavigationMenu.displayAllTextCache) {
                    this.menus = NavigationMenu.menusCache;
                    this.displayAllText = NavigationMenu.displayAllTextCache;
                    return this.render();
                }
                ...
                .then(({ data }) => {
                    ...
                    NavigationMenu.displayAllTextCache = this.displayAllText;
                    return this.render()
    ...
    * @returns {String}
    */
    getSimpleMobileMenus() {
        return this.menus.map((menu) => `
            <salla-button href="${menu.url}"
    ...
    */
    render() {
        if (this.isMobile) {
            this.innerHTML = `<div class="teela-mobile-nav-scroll p-2 flex justify-start sm:justify-center gap-2 overflow-x-auto w-full">${this.getSimpleMobileMenus()}</div>`;
        } else {
            this.innerHTML =  `
